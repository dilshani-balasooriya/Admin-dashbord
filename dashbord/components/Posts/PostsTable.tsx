...
const PostsTable=({limit,title}: PostTableProps)=>{
    ...
    const filteredPost=limit ? sortedPosts.slice(0,limit):
    sortedPosts;
                    ...
                    {filteredPost.map((post) =>(
                          <TableRow key={post.id}>
                           ...
                           <TableCell>
                            ...
                            <Button className="bg-blue-500 hover:bg-blue-700 text-whiit font-bold py-2 px-4 roundded text-1xl" >Edit</Button>
                           </TableCell>
                          </TableRow>
                    ))}
                </TableBody>
