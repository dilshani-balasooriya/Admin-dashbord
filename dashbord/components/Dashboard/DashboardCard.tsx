...
interface DashbioardCardProps{
    title:string;
    count:number;
    icon:React.ReactElement<LucideIcon>
}
const DashbioardCard =({title,count,icon}:DashbioardCardProps) =>{
    return(
        <Card className="bg-slate-100 dark:bg-slate-800 p-4 pb-0">
            <CardContent>
                ...
                <div className="flex gap-5 justify-center items-center">{icon}
